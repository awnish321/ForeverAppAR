...
package foreverappar.com.SampleApplication;
...
import foreverappar.com.SampleApplication.utils.VideoBackgroundShader;
...
public class SampleAppRenderer {
    ...
    public void render()
    {
        ...
        for (int v = 0; v < viewList.getNumViews(); v++)
        {
            ...
            float eyeAdjustmentGL[] = Tool.convertPose2GLMatrix(mRenderingPrimitives
    ...
    public void configureVideoBackground()
    {
        ...
        // The Vuforia Engine VideoBackgroundConfig takes the position relative to the
