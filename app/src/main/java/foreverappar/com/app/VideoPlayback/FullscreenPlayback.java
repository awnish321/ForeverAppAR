    ...
    OnCompletionListener
{
    ...
    private void createMediaPlayer()
    {
        ...
        try
        {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
              SDCardRoot = getApplicationContext().getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS);
                Log.d("awa0", "" + SDCardRoot);
            }else{
                SDCardRoot = Environment.getExternalStorageDirectory();
            }
            File file = new File(SDCardRoot,mMovieName);
    ...
    private final MediaController.MediaPlayerControl player_interface = new MediaController.MediaPlayerControl()
    {
